...
situation_initiale([ [_,_,_,_,_,_,_],
					 [_,_,_,_,_,_,_],
					 [_,_,_,_,_,_,_],
					 [_,_,_,_,_,_,_],
					 [_,_,_,_,_,_,_],
...
situation_croix([ [o,x,o],
                  [o,x,o],
                  [x,o,x] ]).

situation_croix2([ [o,x,o],
				   [x,x,x],
				   [x,o,o] ]).		

situation_croix3([ [o,x,o],
				   [x,_,_],
				   [x,o,x] ]).	
				   
situation_croix4([ [o,x,o], 
					[x,_,_],
			       [_,o,_] ]).	%[o,x,o],[x,_,_],[_,o,_] ]	
...
alignement_perdant(Ali, J) :- ground(Ali), adversaire(J,K), possible(Ali,K).
...
successeur(J, Etat,[L,C]) :-
		nth1(L,Etat,Ligne),
		nth1(C,Ligne,X),
		var(X),           % verifie que cette case est une variable LIBRE !!
		X=J.
...
heuristique(J,Situation,H) :-
	findall(Alig, (alignement(Alig,Situation), possible(Alig, J)), PointJoueur), 
	length(PointJoueur,Sum), 
	adversaire(J,K),
	findall(Alig, (alignement(Alig,Situation), possible(Alig, K)), PointAdversaire), 
	length(PointAdversaire,Sum2), 
	H is (Sum - Sum2). 
