...
alignement_perdant(Ali, J) :- 
	adversaire(J,K), alignement_gagnant(Ali,K).
...
heuristique(J,Situation,H) :-
	adversaire(J,K),
	findall(Alig, (alignement(Alig,Situation), possible(Alig, J),alignement_gagnant(Alig,J)), PointJoueur), 
	length(PointJoueur,Sum), 
	findall(Alig2, (alignement(Alig2,Situation), possible(Alig2, K),alignement_gagnant(Alig2,K)), PointAdversaire), 
